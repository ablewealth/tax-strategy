...
const EnvTest = () => {
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>API Key Configured:</strong> {apiKey ? 'YES' : 'NO'}
      </p>
      <p>
        <strong>API Key Length:</strong> {(apiKey || '').length}
      </p>
      <p>
        <strong>API Key Preview:</strong> {apiKey ? `${apiKey.substring(0, 10)}...` : 'Not set'}
      </p>
      <p>
